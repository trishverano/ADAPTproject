window.APP_CONFIG = {
  ...
  municipalitySlug: 'pola',
  municipalityName: 'Pola, Oriental Mindoro',
  center: [121.44, 13.15],
  zoom: 13,
  extent4326: [121.36, 13.06, 121.53, 13.22],
  logos: {
    municipality: '../../shared/assets/img/logos/municipality-logo.png',
    sponsor1: '../../shared/assets/img/logos/pfpi-logo.png',
    sponsor2: '../../shared/assets/img/logos/sponsor-2.png'
  },
  weather: {
    latitude: 13.1439,
    longitude: 121.4417,
